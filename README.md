...
## Data
#### The data file contains train.csv, test.csv files downloaded from UCI repository and full_data.csv file  which contains data after cleaning and preparing it for modeling
## Feature
- age: Age
